...
<?php $customer_id =$this->uri->segment(3); ?>
	<a href="<?php echo base_url() ?><?php echo $v['additional_url']; ?>/<?php echo $user_data['id'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit" title="Additional information"> Additional</i></a>	
