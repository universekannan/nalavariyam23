...
$newDate = date("d-m-Y", strtotime($originalDate)); 
 ...
 <?php } ?>
<td> 
                             <a href="<?php echo base_url('wallet/paymentdeletes/') ?><?php echo $row->id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-trash" title="Push to Government Website"> Delete </i></a>
