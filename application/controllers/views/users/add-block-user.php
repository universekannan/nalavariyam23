...
<?php if($this->session->userdata('group_id') == '4'){ ?>
                <h3 class="card-title">Add Block Presidents  </h3>
<?php } if($this->session->userdata('group_id') == '5'){ ?>
                <h3 class="card-title">Add Block Secretarys  </h3>
<?php } ?>          </div>
          <!-- /.card-header -->
          <div class="card-body">
              <form action="<?php base_url('users/addblockuser') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
