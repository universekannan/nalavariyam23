...
<?php if($this->session->userdata('group_id') == '2'){ ?>
                <h3 class="card-title">Super User Presidents Details </h3>
<?php } if($this->session->userdata('group_id') == '3'){ ?>
                <h3 class="card-title">Super User  Secretarys Details </h3>
<?php } ?>
      <a href="<?php echo base_url('users/adddsuperusers') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Presidents"><i class="fas fa-plus"> Add</i> </a>
              </div>
...
<a class="dropdown-item" href="<?php echo base_url('users/assigned/'.$row->group_id.'/'.$row->id) ?>">Assigned</a>
