...
<?php if(($this->session->userdata('group_id') == '2') || ($this->session->userdata('group_id') == '4')){ ?>
                <h3 class="card-title">Taluk Presidents Details </h3>
<?php } if(($this->session->userdata('group_id') == '3') || ($this->session->userdata('group_id') == '5')){ ?>
                <h3 class="card-title">Taluk Secretarys Details </h3>
<?php } ?>
<?php if($this->session->userdata('group_id') == '4'){ ?>
      <a href="<?php echo base_url('users/addtalukusers/6') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Taluk"><i class="fas fa-plus"> Add</i> </a>
<?php } if($this->session->userdata('group_id') == '5'){ ?>
      <a href="<?php echo base_url('users/addtalukusers/7') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Taluk"><i class="fas fa-plus"> Add</i> </a>
<?php } ?>
