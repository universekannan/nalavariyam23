    ...
    $renew_payment = $data->renew_payment;
	 if($data){ 
      if($status = $this->session->userdata('status') == 'Inactive'){ ?>
            <center><h1>தற்காலிக ஐடியில் 
விண்ணப்ப கட்டணம் ரூ.150/-
 </br> எப்போது வேண்டுமானாலும் நிரந்தர ஐடிக்கான கட்டணம் செலுத்தி </br> விண்ணப்ப கட்டணம் ரூ.120/- பெறலாம்</h1></br>
		  ...
		  <div class="row">
		   ...
		   <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="<?php echo base_url('freeuser') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
<div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              ...
              <a href="<?php echo base_url('freeuser/wallet') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
		   <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              ...
              <a href="<?php echo base_url('freeuser/followup') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
		   <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
