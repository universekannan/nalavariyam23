	  ...
	  <td><?php echo $row->family_relationship; ?></td>
          ...
          <?php if(in_array('updateUser', $user_permission) || in_array('deleteUser', $user_permission)): ?>
                        <td>
                          ...
                          <a href="<?php echo base_url('freeuser/editfamily/'.$row->id) ?>/<?php echo $row->customer_id; ?>" class="btn btn-info" title="Edit">  <i class="fa fa-edit"> Edit</i> </a>
			...
			<div class="col-md-6">           
				...
				<div class="form-group row">
        		 ...
        		 <div class="callout callout-danger">
                  <h5>NotesAdmission Mgwt (Application Form)

Students Details

Staff Details

Exam ManageMent (Hall Location,Subjects)(Discussion Need)
