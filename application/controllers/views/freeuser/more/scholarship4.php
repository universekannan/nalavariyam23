          ...
          <div class="col-12">
			...
			<div class="col-md-6">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input disabled  value="<?php echo $family_member_data['school_name'] ?>" required="requiered" type="text" class="form-control" name="school_name" maxlength="50" placeholder="School name">
					</div>
				</div>
				  <div class="form-group row">
					<label for="school_address" class="col-sm-4 col-form-label"><span style="color:red"></span>School Name Address</label>
					<div class="col-sm-8">
						<textarea disabled  rows="5" required="requiered" type="text" class="form-control" name="school_address" id="school_address" maxlength="1000" placeholder="School Name Address"> <?php echo $family_member_data['school_address'] ?></textarea>
					</div>
				</div>					   
                <div class="form-group row">
					<label for="certificate_issued_date" class="col-sm-4 col-form-label"><span style="color:red"></span>Certificate Issued Date</label>
					<div class="col-sm-8">
						<input disabled  value="<?php echo $family_member_data['certificate_issued_date'] ?>"  required="requiered" type="date" class="form-control" name="certificate_issued_date" maxlength="50">
					</div>
				</div>
			 ...
			 <div class="col-md-6">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input  value=""  required="required" type="text" class="form-control" name="studying_course" id="studying_course" maxlength="12" placeholder="Enter Course Name & Year of Studying">
					</div>
				</div>	
				...
				<div class="form-group row">
					...
					<div class="col-sm-8 custom-file">
						<input type="file" class="custom-file-input" name="bank_entry_file" id="bank_entry_file">
