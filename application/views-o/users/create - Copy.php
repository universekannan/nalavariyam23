...
<?php if(($this->session->userdata('group_id') == '2') || ($this->session->userdata('group_id') == '3') || ($this->session->userdata('group_id') == '4') || ($this->session->userdata('group_id') == '5') ){ ?>
                <h3 class="card-title">Add Super User or Center</h3>
<?php } if(($this->session->userdata('group_id') == '6') || ($this->session->userdata('group_id') == '7') || ($this->session->userdata('group_id') == '8') || ($this->session->userdata('group_id') == '9') || ($this->session->userdata('group_id') == '10') || ($this->session->userdata('group_id') == '11')){ ?>
...
<?php } if(($this->session->userdata('group_id') == '6') || ($this->session->userdata('group_id') == '7')){ ?>
<input type="hidden" name="dist_id" value="<?php echo $this->session->userdata('dist_id'); ?>"/>
<input type="hidden" name="taluk_id" value="Null"/>
<?php } ?>  
				<div class="form-group row">  
