                  ...
                  <tbody>
                     ...
                     <tr>
                      ...
                      if($bill_status == '1'){ ?>
                           ...
                           <a href="<?php echo base_url('reports/receipt/'.$row->customer_id.'/'.$row->id) ?>" class="btn btn-default"><i class="fa fa-eye"></i>  Bill</a>
                           <?php } ?>
                           <div class="modal fade" id="Billing<?php echo $row->id; ?>">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <form action="<?php echo base_url('reports/billcreate') ?>" method="post"  class="form-horizontal">
