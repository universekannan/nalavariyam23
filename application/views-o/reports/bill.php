...
<section class="content">
   ...
   <hr>
   <div class="row mb-4">
   <?php $referral_id = $this->session->userdata('id'); 
   ...
   <div class="col-sm-6">
      ...
      <div><?php echo $permanent_address_1 ; ?></div>
   </div>
      ...
      <div>
         ...
         <div>
            ...
            <?php $customer_id =$this->uri->segment(3); 
               ...
               $customer_address_1= $data->permanent_address_1;
               ?>
            <div class="row mb-4">
               <div class="col-sm-9">
                  <div>
                     <strong>Bill To : </strong><?php echo $customer_address_1; ?>.
                  </div>
               </div>
               <div class="col-sm-3">
            ...
            <div class="table-responsive-sm">
               <table class="table table-striped">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="left strong"><?php echo $amount; ?></td>
               ...
               <div class="callout callout-danger">
                  <h5><?php $get_amount= AmountInWords($amount);
