        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rettan Applys</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Rettan Applys</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(in_array('updateDistrict', $user_permission)): ?>
                                     <a href="<?php echo base_url('reports/rettanapply/'.$v['id']) ?>" class="btn btn-default"><i class="fa fa-edit"></i>Change</a>
                          <?php endif; ?>
