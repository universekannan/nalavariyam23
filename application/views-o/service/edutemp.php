            ...
            <div class="card">
              <div class="card-header">
				...
				<ol class="float-sm-right">
						<a href="<?php echo base_url('customers/familytemp/') ?><?php echo $this->uri->segment(3); ?>"  class="btn btn-info">Go to Family</a>
                </ol>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$service_id = $this->uri->segment(4); ?>
      <a href="<?php echo base_url('service/edunext/'.$customer_id) ?>/<?php echo $service_id; ?>/<?php echo $row->id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right " title="Next"> Next</i></a>  
</td>
                      </tr>
                   <?php } ?>
                </tbody>
