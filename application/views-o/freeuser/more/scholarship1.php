				  ...
				  <div class="form-group row">
					...
					<div class="col-sm-8">
						<select class="form-control select2bs4" name="studying_course" id="studying_course" style="width: 100%;" required="required">
							<option value="6-th studying">6-th studying</option>
							<option value="7-th studying">7-th studying</option>
							<option value="8-th studying">8-th studying</option>
							<option value="9-th studying">9-th studying</option>
						</select>
					</div>
				  </div>
				<div class="form-group row">
