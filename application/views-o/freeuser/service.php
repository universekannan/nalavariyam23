...
<?php if(($this->session->userdata('group_id') == '4') || ($this->session->userdata('group_id') == '5')){ ?>
                              <a href="<?php echo base_url('freeuser/servicedelete/') ?><?php echo $image_id ?>/<?php echo $customer_id ?>" class="btn btn-sm btn-primary"><i class="fa fa-upload" title="Push to Government Website"> Delete </i></a>
							   <?php } ?>
                              <?php } else{ ?>
  ...
  <?php } if($data1->next_url == '2'){ ?>
      <a href="<?php echo base_url('freeuser/edu/'.$customer_id) ?>/<?php echo $v['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right " title="Next"> Next</i></a>  
   <?php } if($data1->next_url == '3'){ ?>
      <a href="<?php echo base_url('freeuser/renewal/'.$customer_id) ?>/<?php echo $v['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right " title="Next"> Next</i></a>  
   <?php } 
   ?>
     </td>                         
