                ...
                <div id="accordion">
                  <div class="card card-primary">
                    ...
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                      <div class="card-body">
              <form action="<?php base_url('customers/create') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<?php } if(($this->session->userdata('group_id') == '3') || ($this->session->userdata('group_id') == '5') || ($this->session->userdata('group_id') == '7') || ($this->session->userdata('group_id') == '9') || ($this->session->userdata('group_id') == '11') || ($this->session->userdata('group_id') == '1')){ ?>
...
<?php if(($this->session->userdata('group_id') == '2') || ($this->session->userdata('group_id') == '3') || ($this->session->userdata('group_id') == '4') || ($this->session->userdata('group_id') == '5')){ ?>
	...
	<div class="form-group row">
		...
		<div class="col-sm-8">
		    ...
		    <option value="<?php echo $user_data['dist_id'] ?>">Select District</option>
