...
<div class="row">
			...
			<div class="col-md-9 laba">
				<?php echo $user_data['work_there_name'] ?>
			</div>
		</div>
</div>
...
<div class="row">
	...
	(Ntiyaspg;gth;</b> / <b class="lab">gjpT ngw;w njhopw;rq;f epHthfp </b> / <b class="lab"> </br>
	</b><b class="e">VAO or RI</b><b class="lab">(nrd;id) </b> / <b class="lab"> gjpT ngw;w xg;ge;jjhuh;</b> / <b class="lab"></br>
