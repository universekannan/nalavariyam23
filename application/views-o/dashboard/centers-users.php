...
$sql="with recursive cte (id, group_id, referral_id, profile_photo, full_name) as (
  select     id,
             group_id,
             referral_id,
             profile_photo,
  ...
  foreach($result as $row) { ?>
         ...
         <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <center>
                <img src="<?php $row->profile_photo; ?>" class="img-circle elevation-2"style="width:150px">
                <h3><p><?php $row->full_name; ?></p></h3>
        </center>
              </div>
              <a href="" class="small-box-footer"> State President</a>
            </div>
