      ...
      <p class="login-box-msg">Register a new User</p>
        	...
        	<div class="card-body">
        			<?php 
		                ...
		                echo "We have received a payment of Rs. " . $amount . ". We activate your Login id within 1hour.</p>";
		            ?>
             </div>
			 
			  <?php echo form_open(base_url("Status/register"), 'class="form-horizontal"');  ?> 
