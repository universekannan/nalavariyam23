                  ...
                  <?php if($Orders_data): ?>                  
                    <?php foreach ($Orders_data as $k => $v): ?>
                      <tr>
                        ...
                        <td>
						          <a href="<?php echo base_url('bulk/vieworders/'.$v['log_id'].'/'.$v['id']) ?>" class="btn btn-primary btn-sm float-sm-right" title="Add service"><i class="fas fa-eye"> View Orders</i> </a>
