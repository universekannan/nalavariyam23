          ...
          <div class="col-md-12">
           <div class="row">
            ...
            <div class="card" id="html-content-holder">
                <div class="card-body">
               <center>
      <b class="lab"><h5> <b>jkpo;ehL fl;Lkhdk; mikg;Grhuh xl;LeH; kw;Wk; ,ju 15 clYiog;G njhopyhsH eythhpaq;fs;</b></h5>
...
<div class="card-body">
        <div class="row">
          <div class="col-6 ">
            ...
            <div class="form-group lab">
            <br><br>gjpT ngw;w cWg;gpdhpd; ngah;
                   </div>
         ...
         <u class="lab">je;ij</u>  / <u class="lab">fzth; ngaH</u> 
            ...
            <div class="form-group">
            <br><br><br><br><u class="lab">gjpT vz;</u>  / <u class="lab">ehs;</u> 
                   </div>
            <div class="form-group lab">
            FLk;g ml;il vz;
                   </div>
...
$newDate2 = date("d-m-Y", strtotime($originalDate)); ?>
	...
	<center><b>gjpTngw;w cWg;gpdhpd; ifnahg;gk;</b></center> </div>
	</div>	
    <div class="row">
      <div class="card-body">
      <hr style="border: 1px solid #555; width:100%">
	<center><b><h5 class="lab">rhd;W</b></h5></center>
...
<div class="card-body">
 ...
 <p class="la">,lk; : <b class="laba"><?php echo $user_data['p_address_1_tamil'] ?></b></br></br>
