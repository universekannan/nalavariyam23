               ...
               <div class="card" id="html-content-holder">
                  <div class="card-body">
                     <center>
                        ...
                        <b> IX -(A)</b> <b class="las">gphpT 21(3)</br>
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-5 laba">
                              <div class="form-group">
                                 : <?php echo $user_data['permanent_door_no'] ?><br>
                                 <?php echo $user_data['p_address_1_tamil'] ?><br>
                                 <?php echo $user_data['p_address_2_tamil'] ?><br>
                                 <?php echo $user_data['district_name'] ?> - <?php echo $user_data['pincode'] ?>
                              </div>
                           </div>
                        </div>
                        <div class="row">
