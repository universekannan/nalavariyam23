...
<?php if(($this->session->userdata('group_id') == '2') || ($this->session->userdata('group_id') == '4')){ ?>
                <h3 class="card-title">Block Presidents Details </h3>
<?php } if(($this->session->userdata('group_id') == '3') || ($this->session->userdata('group_id') == '5')){ ?>
                <h3 class="card-title">Block Secretarys Details </h3>
<?php } ?>
<?php if($this->session->userdata('group_id') == '4'){ ?>
      <a href="<?php echo base_url('users/addblockuser/10') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Block Presidents Users"><i class="fas fa-plus"> Add</i> </a>            
<?php } if($this->session->userdata('group_id') == '5'){ ?>
      <a href="<?php echo base_url('users/addblockuser/11') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Block Secretarys Users"><i class="fas fa-plus"> Add</i> </a>
<?php } ?>        
                          </div>
...
<a href="<?php echo base_url('users/edit/'.$row->group_id.'/'.$row->id) ?>" class="btn btn-primary btn-sm" title="Edit">  <i class="fa fa-edit"> Edit</i> </a>
