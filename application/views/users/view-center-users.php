<div class="content-wrapper">
      <div class="card-header">
                  ...
                  <?php if(($this->session->userdata('group_id') == '4') || ($this->session->userdata('group_id') == '6') || ($this->session->userdata('group_id') == '8') || ($this->session->userdata('group_id') == '10')){ ?>
                  <a href="<?php echo base_url('users/addcenterusers/12') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Taluk"><i class="fas fa-plus"> Add</i> </a>
                  <?php } if(($this->session->userdata('group_id') == '5') || ($this->session->userdata('group_id') == '7') || ($this->session->userdata('group_id') == '9') || ($this->session->userdata('group_id') == '11')){ ?>
                  <a href="<?php echo base_url('users/addcenterusers/13') ?>" class="btn btn-primary btn-sm float-sm-right" title="Add Taluk"><i class="fas fa-plus"> Add</i> </a>
                  <?php } ?>
               </div>
                           ...
                           <div class="modal-dialog">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <center>
                                    <a class="btn btn-info" href="https://api.whatsapp.com/send?phone=91<?php echo $row->phone; ?>&text=Sir, We are from NalaVariyam , Your Login UserName : <?php echo $row->username; ?>, Password : <?php echo $row->pas; ?>, Contact Us : Mobile 7598984380 Email : ramjitrust039@gmail.com, Websit : www.nalavariyam.com. I have attached your Login website  link below <?php echo base_url() ?>" data-action="share/whatsapp/share" target="_blank">Send Whatsapp</a>
                                    <center>
                                 </div>
