...
<?php if($this->session->userdata('group_id') == '16'){ ?>
              <a href="<?php echo base_url('users/viewdistrictassignedusers/4') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
<?php } if($this->session->userdata('group_id') == '17'){ ?>
              <a href="<?php echo base_url('users/viewdistrictassignedusers/5') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
<?php } ?>        
            </div>
          </div>
