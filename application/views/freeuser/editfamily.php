	  ...
	  <td><?php echo $row->family_relationship; ?></td>
          ...
          <?php if(in_array('updateUser', $user_permission) || in_array('deleteUser', $user_permission)): ?>
                        <td>
		                  ...
		                  <a href="<?php echo base_url('freeuser/nominee/'.$row->customer_id) ?>/<?php echo $row->id; ?>" class="btn btn-info" title="Edit">  <i class="fa fa-plus"> Nominee </i> </a>
                          <?php endif; ?>
                          <a href="<?php echo base_url('freeuser/delete/'.$row->id) ?>" class="btn btn-danger" title="Delete">  <i class="fa fa-trash"></i></a>
...
<?php } else{ ?>
      <a href="<?php echo base_url('freeuser/delete/'.$row->id) ?>" class="btn btn-info" title="Delete"><i class="fa fa-trash"> Delete</i></a>
<?php } ?>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Add Family Member</h1>
              ...
              <form action="<?php base_url('freeuser/family/') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
		  <div class="row">
			...
			<div class="col-md-6">           
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input value="<?php echo $user_data['family_member_name'] ?>" required="required" type="text" class="form-control" name="family_member_name" id="family_member_name" maxlength="50" placeholder="Member Full Name">
					</div>
				</div>
				<div class="form-group row">
					...
					<option value="<?php echo $user_data['family_relationship'] ?>"><?php echo $user_data['family_relationship'] ?></option>
       		...
       		<div class="form-group row">
        		 ...
        		 <div class="callout callout-danger">
                  <h5>Notes :</h5>
                  <p>கல்வி உதவித்தொகை பெற விண்ணப்பம் செய்ய இரண்டு குழந்தைகளின் விபரம் மட்டும் சேர்க்கவும்</p>
          </div>
         <div class="form-group row">
