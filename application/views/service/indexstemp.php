...
<?php if(($this->session->userdata('group_id') == '4') || ($this->session->userdata('group_id') == '5')){ ?>
  ...
  <?php } if($data1->next_url == '2'){ ?>
      <a href="<?php echo base_url('service/edutemp/'.$customer_id) ?>/<?php echo $v['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right " title="Next"> Next</i></a>  
   <?php } if($data1->next_url == '3'){ ?>
      <a href="<?php echo base_url('service/renewaltemp/'.$customer_id) ?>/<?php echo $v['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-arrow-right " title="Next"> Next</i></a>  
   <?php } 
   ?>
     </td>                         
